...
const DEFAULTS: AppConfigView = {
  ...
  announcement: null,
  playStoreUrl:
    'https://play.google.com/store/apps/details?id=com.pakistani.serials',
  supportEmail: 'support@pakistaniserials.app',
  privacyUrl: 'https://global.animekill.com/api/pakistani-serials/pages/privacy',
  termsUrl: 'https://global.animekill.com/api/pakistani-serials/pages/terms',
  updatedAt: null,
};

@Injectable()
export class PakAppConfigService implements OnModuleInit {
  private readonly logger = new Logger(PakAppConfigService.name);

  constructor(
    @InjectRepository(AppSetting, 'pak')
