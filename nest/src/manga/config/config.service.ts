...
const DEFAULTS: AppConfigView = {
  ...
  announcement: null,
  playStoreUrl:
    'https://play.google.com/store/apps/details?id=com.manga.browser',
  supportEmail: 'support@mangabrowser.app',
  privacyUrl: null,
  termsUrl: null,
  updatedAt: null,
};
...
@Injectable()
export class MangaAppConfigService implements OnModuleInit {
  private readonly logger = new Logger(MangaAppConfigService.name);

  constructor(
    @InjectRepository(MangaAppConfig, 'manga')
    private readonly repo: Repository<MangaAppConfig>,
  ) {}
