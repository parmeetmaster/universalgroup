...
const pakConfig = createConfigSlice({
  name: "pakConfig",
  apiPath: "/api/db/pak/config",
  defaults: DEFAULTS,
...
export const pakConfigReducer = pakConfig.reducer;
export const pakConfigActions = pakConfig.actions;
export const pakConfigThunks = pakConfig.thunks;
export const pakConfigSelectors = pakConfig.selectors;
